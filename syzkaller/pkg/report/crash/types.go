...
// PROBE: Crash severity tiers for exploit-oriented filtering.
// Tier 1 = Critical (direct UAF/OOB), Tier 2 = Important (potential exploitation),
// Tier 3 = Low (noise for exploit purposes).
const (
	TierCritical  = 1
	TierImportant = 2
	TierLow       = 3
...
// Tier returns the PROBE severity tier for this crash type.
func (t Type) Tier() int {
	switch t {
	// Tier 1: Direct UAF or OOB — highest exploit potential.
	case KASANInvalidFree, KASANUseAfterFreeWrite, KASANUseAfterFreeRead,
		KASANWrite, KASANRead,
		KFENCEInvalidFree, KFENCEUseAfterFreeWrite, KFENCEUseAfterFreeRead,
		KFENCEMemoryCorruption, KFENCEWrite, KFENCERead,
		KMSANUseAfterFreeRead:
		return TierCritical
